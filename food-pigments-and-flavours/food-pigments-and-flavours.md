---
title: Food Pigments and Flavours
syllabus:
  - Introduction: Food Pigments
  - Classification of pigments
  - Major classes of pigments
  - Introduction: Food Flavours
  - Flavour compounds
subject: food-technology
chapter: food-pigments-and-flavours
part: 1
module: 16
videos:
  - url-1
...
- Chlorophyllase loses its activity when heated to 100 °C.
...
<figure>
  <img src="image3.png" alt="General anthocyanins structure">
...
- **Methyl Cyclopentenolone (MCP)**—also known as maple lactone, cyclotene or corylone—possesses a powerful caramel aroma and is used to enhance both flavour and sweetness. It is found in foods containing sugars that have been subjected to heat, providing a characteristic 'cooked sugar' profile.
...
- **E.g. of phenols:** p-cresol is particularly phenolic and **smoky**; terpene-derived **thymol** and **eugenol** provide flavour to thyme and clove, respectively; **vanillin**, a key constituent of vanilla, is a phenol with that characteristic sweet vanilla aroma with smoky undertones.
